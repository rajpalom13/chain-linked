...
/**
 * Onboarding Step 3 - Company Context
...
/**
 * Step 3 - Company Context Ingestion
...
export default function Step3() {
  ...
  const pollStatus = useCallback(async () => {
    try {
      ...
      console.error("[Step3] Polling error:", err)
    }
  ...
  /**
   * Skips analysis and proceeds to step 4 with basic data only
   */
